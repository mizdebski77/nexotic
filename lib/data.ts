...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    description: 'W pełni funkcjonalny asystent AI wbudowany w Twoją stronę. Odpowiada klientom 24/7, kwalifikuje leady i odciąża zespół — uczy się Twojej oferty i mówi Twoim głosem.',
...
export const PROJECTS: Project[] = [
  {
    ...
    description: 'Kompleksowe narzędzie CRM dla trenera personalnego, automatyzujące planowanie treningów i komunikację, co pozwala na obsługę 2x większej liczby klientów jednocześnie.',
  },
  {
    name: 'Denti Care',
