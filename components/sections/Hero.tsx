    ...
    return (
        <div className="relative flex justify-end items-end ">
            ...
            <img
                src={heroBg.src}
                alt="Hero"
                className=" max-w-[auto] xl:md:min-w-[1000px]"
            />
        </div>
    );
}
        ...
        <section className="bg-ink pt-[68px] min-h-screen relative overflow-hidden flex items-center">
            ...
            <div className="max-w-[1640px] mx-auto px-6 md:px-10 grid xl:grid-cols-2 gap-10 xl:gap-14 items-center py-16 md:py-20 relative z-10">
                ...
                <div>
                    ...
                    <motion.h1
                        {...fadeUp(0.15)}
                        style={{ lineHeight: isMobile ? "40px" : "60px" }}
                        className="leading-[400px] text-3xl md:text-2xl xl:text-[40px] 2xl:text-5xl  font-extrabold    text-white mb-5"
                    >
                        {t("titleLine1")}
                        <br />
                    ...
                    <motion.p
                        {...fadeUp(0.25)}
                        className="text-[15px] xl:text-base text-white/50 max-w-[440px] mb-8"
                    >
                        {t("subtitle")}
                    </motion.p>
                    ...
                    >
                        <Button href="/uslugi" variant="lime" size="md">
                            {t("ctaPrimary")}
                        </Button>
                        <Button
                            href="/portfolio"
                    ...
                    >
                        <div className="flex">
                            {["AK", "MN", "PW", "JS"].map((ini, i) => (
                                <div
                                    key={ini}
                                    className="w-8 h-8 rounded-full border-2 border-ink bg-ink-3 flex items-center justify-center text-[10px] font-bold text-lime"
                        ...
                        <div>
                            <div className="text-lime text-xs tracking-[1px]">
                                {t("rating")}
                            </div>
                            <div
                                className="text-[12.5px] text-white/45"
                                dangerouslySetInnerHTML={{
                                    __html: t.raw("trustedBy") as string,
                                }}
                            />
                        </div>
                    </motion.div>
