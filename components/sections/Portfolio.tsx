...
// Project visual data (images, names, years) is universal — type and
// description come from translations.
const PROJECTS = [
  { key: 'gymflow',     name: 'GymFlow',     year: '2024', image: '/projects/GymFlow.png' },
  { key: 'denticare',   name: 'Denti Care',  year: '2022', image: '/projects/Denticare.png' },
  { key: 'buildrent',   name: 'Build rent',  year: '2023', image: '/projects/cmr.png' },
